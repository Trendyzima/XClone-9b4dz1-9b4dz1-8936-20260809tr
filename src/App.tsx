...
import { LiveSpacesDiscoveryStrip } from '@/components/features/LiveSpacesDiscoveryStrip';
...
<Route path="/admin/fraud" element={<OwnerOnlyAdminRoute><AdminFraudPage/></OwnerOnlyAdminRoute>}/><Route path="/post/:postId" element={<PostThreadPage/>}/><Route path="/post/:postId/likes" element={<PostLikesPage/>}/><Route path="/post/:postId/replies" element={<PostRepliesPage/>}/><Route path="/post/:postId/reply/:replyId" element={<PostReplyChainPage/>}/><Route path="/post/:postId/reposts" element={<PostRepostsPage/>}/><Route path="/post/:postId/quotes" element={<PostQuotesPage/>}/><Route path="/post/:postId/quote" element={<PostQuoteComposerPage/>}/><Route path="/post/:postId/quote-likes" element={<PostQuoteLikesPage/>}/><Route path="/post-remote" element={<PostThreadPage/>}/><Route path="/post-remote/likes" element={<PostLikesPage/>}/><Route path="/post-remote/replies" element={<PostRepliesPage/>}/><Route path="/post-remote/reply/:replyId" element={<PostReplyChainPage/>}/><Route path="/post-remote/reposts" element={<PostRepostsPage/>}/><Route path="/post-remote/quotes" element={<PostQuotesPage/>}/><Route path="/communities" element={<CommunitiesPage/>}/><Route path="/c/:name" element={<CommunityPage/>}/>
...
<Route path="/fediverse/profile/analytics" element={<FediverseProfileAnalyticsPage/>}/><Route path="/daily-rewards" element={<DailyRewardsPage/>}/><Route path="/leaderboard" element={<LeaderboardPage/>}/><Route path="/leaderboard/challenges" element={<ChallengeLeaderboardPage/>}/><Route path="/discover" element={<DiscoverPage/>}/><Route path="/referral" element={<ReferralPage/>}/><Route path="/referrals" element={<ReferralPage/>}/><Route path="/space-recording/:id" element={<SpaceRecordingViewerPage/>}/><Route path="/spaces/:id" element={<SpaceDetailPage/>}/><Route path="/trending/:topic" element={<TrendingTopicFeedPage/>}/><Route path="/challenge/:id" element={<HashtagChallengePage/>}/><Route path="/admin/ads-review" element={<OwnerOnlyAdminRoute><AdminAdsDashboard/></OwnerOnlyAdminRoute>}/><Route path="/notification-preferences" element={<NotificationPreferencesPage/>}/><Route path="/wishlist" element={<WishlistPage/>}/><Route path="/marketplace" element={<MarketplacePage/>}/><Route path="/shop" element={<ShoppingMallPage/>}/><Route path="/p/:productId" element={<MarketProductPage/>}/><Route path="/polls" element={<PollsPage/>}/><Route path="/interests" element={<InterestOnboardingPage/>}/><Route path="/ad-analytics" element={<AdAnalyticsPage/>}/><Route path="/series" element={<SeriesPage/>}/><Route path="/platform-inbox" element={<PlatformInboxPage/>}/><Route path="/admin/seo" element={<OwnerOnlyAdminRoute><SEOAuditPage/></OwnerOnlyAdminRoute>}/><Route path="/videos/watchlater" element={<VideoWatchLaterPage/>}/><Route path="/hashtags" element={<HashtagDiscoveryPage/>}/><Route path="/podcasts/search" element={<PodcastSearchPage/>}/><Route path="/regulator" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/employees" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/features" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/wallets" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/moderation" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/platform" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/announce" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/reports" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/audit" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/>
<Route path="/regulator/analytics" element={<OwnerOnlyAdminRoute><RegulatorPanel/></OwnerOnlyAdminRoute>}/><Route path="/podcasts/analytics" element={<PodcastAnalyticsPage/>}/><Route path="/team-chat" element={<TeamChatPage/>}/><Route path="/appeals" element={<AppealsPage/>}/><Route path="/leaderboard/creators" element={<CreatorLeaderboardPage/>}/><Route path="/policy" element={<ContentPolicyPage/>}/><Route path="/privacy" element={<PrivacyPolicyPage/>}/><Route path="/terms" element={<TermsOfServicePage/>}/><Route path="/sessions" element={<ActiveSessionsPage/>}/><Route path="/blocked" element={<BlockedUsersPage/>}/><Route path="/seller/:username" element={<SellerStorefrontPage/>}/><Route path="/orders" element={<OrdersPage/>}/><Route path="/story-analytics" element={<StoryAnalyticsDashboard/>}/><Route path="/admin/platform-revenue" element={<OwnerOnlyAdminRoute><PlatformRevenueDashboard/></OwnerOnlyAdminRoute>}/><Route path="*" element={<NotFoundPage/>}/></Routes></Suspense><PublisherFeedStream surface="global" /></main><RightSidebar/><LiveNotificationBanner/><BottomNav/><FloatingActionButton/><InterestOnboardingSheet/></div><Toaster/><Sonner position="top-center" richColors/><Analytics/></AuthProvider>}
