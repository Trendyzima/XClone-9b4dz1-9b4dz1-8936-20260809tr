...
export default function StaffDashboardPage(){
 ...
 const caps=useMemo(()=>{ const keys=governance.is_owner ? Object.keys(CAPABILITIES) : governance.permissions; return keys.map(p=>({key:p,...CAPABILITIES[p]})).filter(x=>x.label); },[governance.permissions,governance.is_owner]);
