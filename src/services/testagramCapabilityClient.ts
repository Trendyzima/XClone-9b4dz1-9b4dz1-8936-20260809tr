...
export class TestagramCapabilityClient{
 ...
 searchUnified(q:string,kind:"all"|"people"|"posts"|"hashtags"|"threads"|"communities"|"fediverse"|"media"|"latest"|"top"="all",n=40){return this.call<any>("testagram.search.unified",{q,kind,limit:limit(n)})}
