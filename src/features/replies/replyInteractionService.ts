...
export async function createReplyQuote(id:string,content:string){const {data,error}=await supabase.rpc('testagram_create_reply_quote',{p_reply_id:id,p_content:content});if(error)throw error;return data;}
