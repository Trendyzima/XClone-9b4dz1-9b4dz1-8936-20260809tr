-- Keep local like/repost writes atomic and count-bearing.
...
grant execute on function public.testagram_toggle_local_like(uuid),public.testagram_toggle_local_repost(uuid) to authenticated;
