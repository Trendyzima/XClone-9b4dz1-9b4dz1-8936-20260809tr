...
export const CAPABILITIES = [
  ...
  { name: "testagram.replies.list", version: 1, access: "authenticated", readonly: true, description: "List visible replies for a post." },
  { name: "testagram.replies.create", version: 1, access: "authenticated", readonly: false, description: "Create a reply through canonical post interaction rules." },
  ...
  { name: "testagram.messages.send_encrypted", version: 1, access: "authenticated", readonly: false, description: "Send an E2EE Testagram message containing ciphertext only." },
  { name: "testagram.messages.edit_encrypted", version: 1, access: "authenticated", readonly: false, description: "Edit an E2EE Testagram message containing ciphertext only." },
  { name: "testagram.messages.delete", version: 1, access: "authenticated", readonly: false, description: "Delete a Testagram message owned by the caller." },
  { name: "testagram.messages.attach", version: 1, access: "authenticated", readonly: false, description: "Attach owned media to a Testagram message." },
  { name: "testagram.communication.devices.list", version: 1, access: "authenticated", readonly: true, description: "List public communication device identities for conversation members." },
  { name: "testagram.communication.keys.list", version: 1, access: "authenticated", readonly: true, description: "List encrypted conversation-key envelopes for the caller." },
  { name: "testagram.communication.keys.put", version: 1, access: "authenticated", readonly: false, description: "Store an encrypted conversation-key envelope." },
  { name: "testagram.communication.e2ee.status", version: 1, access: "authenticated", readonly: true, description: "Read the communication E2EE policy boundary." },
  ...
  { name: "testagram.posts.like.state", version: 1, access: "authenticated", readonly: true, description: "Read the caller like state for a visible post." },
  ...
  { name: "testagram.posts.repost.state", version: 1, access: "authenticated", readonly: true, description: "Read the caller repost state for a visible post." },
